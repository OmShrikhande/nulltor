...
import {
  ...
  Pencil, Trash2, FilePlus, FolderPlus, ChevronRight, ChevronDown, Check,
} from 'lucide-react';
    ...
    <>
      ...
      >
        <span style={{ fontSize: '11px', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-secondary)' }}>
          Explorer {selectedFolderId && <span style={{ fontSize: '10px', color: 'var(--aurora-mint)', textTransform: 'none', fontWeight: 600 }}>[Folder Active]</span>}
        </span>
...
function TreeNodeRow({
  ...
  const isSelected = selectedId === node.id || (isDir && selectedFolderId === node.id);
      ...
      >
        ...
        {isRenaming ? (
          <input
            ...
            onClick={(e) => e.stopPropagation()}
            style={{
              flex: 1, background: 'var(--bg-0)', border: '1px solid var(--aurora-mint)',
  ...
  return (
    ...
    >
      <div className="form-field" style={{ marginBottom: 12 }}>
        <label style={{ color: 'var(--aurora-mint)', fontWeight: 700, fontSize: 12 }}>Item Type</label>
        <div style={{ display: 'flex', gap: 8, marginTop: 4 }}>
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: 6,
              background: type === 'file' ? 'rgba(1, 239, 172, 0.15)' : 'var(--bg-2)',
              border: type === 'file' ? '1px solid var(--aurora-mint)' : '1px solid var(--border)',
              color: type === 'file' ? 'var(--aurora-mint)' : 'var(--text-secondary)',
              fontWeight: 600,
              padding: '6px 12px',
            }}
          ...
          <button
            ...
            style={{
              ...
              justifyContent: 'center',
              gap: 6,
              background: type === 'dir' ? 'rgba(1, 239, 172, 0.15)' : 'var(--bg-2)',
              border: type === 'dir' ? '1px solid var(--aurora-mint)' : '1px solid var(--border)',
              color: type === 'dir' ? 'var(--aurora-mint)' : 'var(--text-secondary)',
              fontWeight: 600,
              padding: '6px 12px',
            }}
            onClick={() => setType('dir')}
      ...
      <div className="form-field" style={{ marginBottom: 12 }}>
        <label style={{ color: 'var(--aurora-mint)', fontWeight: 700, fontSize: 12 }}>Destination Folder</label>
        <select
      ...
      <div className="form-field" style={{ marginBottom: 8 }}>
        <label style={{ color: 'var(--aurora-mint)', fontWeight: 700, fontSize: 12 }}>
      ...
      {activeFolderName && (
        <div style={{ fontSize: 11, color: 'var(--text-muted)', marginBottom: 8, background: 'var(--bg-2)', padding: '4px 8px', borderRadius: 4 }}>
          Will be created inside: <strong style={{ color: 'var(--aurora-mint)' }}>/{activeFolderName}</strong>
        </div>
      )}
