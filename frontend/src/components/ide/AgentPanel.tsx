...
import { Bot, User, Send, CheckCircle2, RotateCcw, Settings2, FileCode, ShieldCheck, X, RefreshCw, Copy, Check, Sparkles, Terminal, Code2, ArrowUpRight } from 'lucide-react';
>>>>>>> Stashed changes
