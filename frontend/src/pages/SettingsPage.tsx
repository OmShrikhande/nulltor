...
import { Settings, Type, AlignLeft, WrapText, Monitor, RotateCcw, Menu } from 'lucide-react';
      ...
      <div className="main-content">
        <div className="page-container">
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 32 }}>
            ...
            <div style={{ width: 44, height: 44, borderRadius: 12, background: 'var(--bg-2)', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Settings size={22} style={{ color: 'var(--sapphire-light)' }} />
            </div>
            <div>
            ...
            {saved && (
              <span style={{ marginLeft: 'auto', fontSize: 12, color: 'var(--accent-secondary)', fontWeight: 700, background: 'var(--bg-2)', padding: '4px 12px', borderRadius: 99, border: '1px solid var(--border)' }}>
                ✓ Saved
              </span>
            )}
          </div>
